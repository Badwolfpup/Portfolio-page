...
export const projects: ProjectType[] = [
  ...
  },
  {
    ...
    description: "Tekniska höjdpunkter: - Objektorienterad design: Använder klasser för spelare, kortlek och spelhantering. - Grafisk UI-hantering: Windows Forms används för att rendera spelets visuella komponenter. - Händelsehantering: Implementerar klickhändelser och UI-uppdateringar i realtid. - Ljudintegration: Använder NAudio-biblioteket för att spela ljudeffekter. - Flerspelarstöd: Hanterar flera spelare genom dynamisk spelardata. Projektet visar min förmåga att utveckla spel och interaktiva Windows-applikationer med C# och Windows Forms. (Beskrivning genererad av ChatGPT)",    
  ...
  },
  {
    ...
    description: "Tekniska höjdpunkter: - DOM-manipulation: Använder JavaScript för att dynamiskt uppdatera spelets UI. - Händelsehantering: Implementerar drag-och-släpp-funktionalitet för kortflyttning. - Spellogik: Hanterar kortlekar, draghögar och vinstkontroller med strukturerad kod. - Responsiv design: Anpassad för olika skärmstorlekar genom flexibla CSS-stilar. Projektet demonstrerar min förmåga att utveckla interaktiva webbapplikationer med JavaScript och en genomtänkt UI-design. (Beskrivning genererad av ChatGPT)",    
