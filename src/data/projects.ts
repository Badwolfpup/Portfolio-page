...
export const projects: ProjectType[] = [
  {
    ...
    title: "Receptapp",
    shortDescription: "ReceptApp är en modern Windows-applikation utvecklad i C# med WPF och MVVM-designmönster. Programmet gör det möjligt för användare att hantera, organisera och visa recept på ett användarvänligt sätt. Tekniska höjdpunkter: MVVM-arkitektur: Implementerar god separering av logik och gränssnitt för ökad skalbarhet och testbarhet. Databindning & INotifyPropertyChanged: Dynamisk uppdatering av UI-komponenter genom databindning. Navigation & Sidhantering: Använder WPF Pages för att hantera olika vyer smidigt. Responsiv och dynamisk UI: Byggd med XAML för en modern och användarvänlig design. Asynkron bearbetning: Använder Dispatcher för att hantera UI-uppdateringar utan att blockera huvudtråden. Denna applikation visar min förmåga att utveckla fullständiga desktop-applikationer med C# och WPF samt att följa moderna designprinciper för en strukturerad och underhållbar kodbas.",    
